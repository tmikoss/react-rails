...
A fork of react-rails 1.4.2, coaxed to work with Rails >5.0

Please don't use this, it's a very specific hack for a very specific situation, some features might (read: will) be broken.
